 ...
 public static void main(String args[]){
  ...
  switch(parametro){
   case 1:resultado = num_uno + num_dos;
          System.out.println("El resultao de la suma es: " + resultado);
          break;
   ...
   case 3:resultado = num_uno * num_dos;
          System.out.println("El resultao de la multiplicacion es: " + resultado);
          break;

   case 4:resultado = num_uno / num_dos;
          System.out.println("El resultao de la division es: " + resultado);
          break;
